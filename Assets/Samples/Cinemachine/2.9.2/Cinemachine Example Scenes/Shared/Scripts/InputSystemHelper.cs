...
namespace Cinemachine.Examples
{
    public static class InputSystemHelper
    {
        ...
        public static void EnableBackendsWarningMessage()
        {
            ...
            {
                Debug.Log(
                    "Old playerInput backends are disabled. Cinemachine examples use Unity’s classic playerInput system. " +
                    "To enable classic playerInput: Edit > Project Settings > Player, " +
